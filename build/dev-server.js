...
app.use(config[ENV]['locationFilter'], proxyMiddleware({
	target: config[ENV]['locationApi'],
	changeOrigin: true
}))

app.use(config[ENV]['skuFilter'], proxyMiddleware({
	target: config[ENV]['skuApi'],
	changeOrigin: true
}))

app.use(config[ENV]['skuDetailFilter'], proxyMiddleware({
	target: config[ENV]['skuDetailApi'],
	changeOrigin: true
}))
